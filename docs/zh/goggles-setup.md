...
<iframe style="width: 100%; height: 500px" src="https://player.bilibili.com/player.html?isOutside=true&aid=114993219509433&bvid=BV19St2zkEUq&cid=31570200195&p=1&muted=false&poster=true" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>
...
2. HDZero眼镜的光学模组表面镀膜，如果用力擦拭将留下无法修复的划痕，这不属于保修范畴。建议采用眼镜自带的眼镜布或者其他软材质的布料，千万不要用力，小心擦拭。超细纤维布容易吸附灰尘或碎屑，这些物质可能会划伤光学镀膜，切勿用衣服擦拭镜片。最安全的方法是使用一次性眼镜清洁湿巾（蔡司是常用的选择），并始终轻柔擦拭，切勿用力按压。
